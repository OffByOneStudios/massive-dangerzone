...
class UnixOperatingSystem(object):
    ...
    def load_memory(self, artifact):
        ...
        artifact.cdll = ctypes.cdll.LoadLibrary(str(module_dll_file))
    ...
    def load_init(self, artifact, requires):
        ...
        artifact.pointer = return_pointer
    ...
    def get_function(self, artifact, index):
        ...
        Returns:
            A function pointer
        """
        artifact_dll, artifact_pointer = self.loadedimports_plugins[artifact]

        artifact_pointer_pointer_type = ctypes.POINTER(ctypes.c_void_p)

        func_pointer = ctypes.cast(artifact_pointer, artifact_pointer_pointer_type)[index]
