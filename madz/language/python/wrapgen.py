...
"""void ___madz_init(){{
    ...
    python_thread_state = Py_NewInterpreter();
    ...
    p = PyObject_CallObject(fn, Py_BuildValue("(s)", "_madz"));
    Py_XDECREF(fn);
    Py_XDECREF(implib);
    Py_XDECREF(importer);
    ...
    fn = PyObject_GetAttrString(p, "_madz_init");
...
{function_callbacks}
    ...
    sys.path.append({outgoing_module_path})
"""
...
"""
    ...
    def generate(self):
        ...
        code_fragments={
                        ...
                        "outgoing_module_path":self.language.get_wrap_directory(),
