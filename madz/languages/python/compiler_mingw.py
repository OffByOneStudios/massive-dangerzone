...
class MinGWCompiler(c_mingw.MinGWCompiler):
    def args_compile(self, source_files):
        ...
        return [self.binary_name_compiler(), "-c", "-I"+self.language.get_wrap_directory(), "-IC:\Python33\include", "-LC:\Python33\libs"] + source_files  + ["-lpython33"]


    def args_link(self, object_files):
        return [self.binary_name_linker(), "-shared", "-LC:\Python33\libs", "-o", self.language.get_output_file()] + object_files + ["-lpython33"]
