...
plugin = Plugin(
    ...
    language="c",
    # The list of libraries to use, the math library is configured in 
    # the system_config:
    libraries=["math"],
    ...
    description=[
        ...
        # A function provided by the plugin that returns a float based off of
        # the global variable. Uses the math library.
